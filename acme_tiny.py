...
def get_crt(account_key, csr, acme_dir, skip_test, log=LOGGER, CA=DEFAULT_CA):
...
def main(argv):
    ...
    parser.add_argument("--skip-test", default=False, help="skip HTTP self test. Helpfull behind NATs.")
    parser.add_argument("--ca", default=DEFAULT_CA, help="certificate authority, default is Let's Encrypt")

    args = parser.parse_args(argv)
    LOGGER.setLevel(args.quiet or LOGGER.level)
    signed_crt = get_crt(args.account_key, args.csr, args.acme_dir, args.skip_test, log=LOGGER, CA=args.ca)
